...
//! Interrupt service routines and Cortex-M Vector Table
...
/// Number of vectors in the standard ISR table
pub const ISR_COUNT: usize = 16;
...
/// It wraps handlers? Or something. This came from Zinc - no clue.
#[no_mangle]
